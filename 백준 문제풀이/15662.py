...
gears = []
# 톱니바퀴의 개수를 입력받아서, 톱니바퀴 개수만큼 정보 입력받기
t = int(input())
for _ in range(t):
    gear_state = input()
...
for _ in range(int(input())):
    ...
    # 톱니바퀴 개수만큼 톱니바퀴 정보 초기화
    direction = [0 for _ in range(t)]  # 현재 연산에서의 회전방향 초기화
...
# 최종 연산 이후, 12시방향이 S극인 톱니바퀴의 개수를 출력한다.
print(calc_point())
